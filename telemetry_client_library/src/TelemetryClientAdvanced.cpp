...
namespace TelemetryAPI {
    ...
    class TelemetryClientAdvanced::AdvancedImpl {
       public:
        ...
        std::string sendCommandAsync(TelemetryClient* client, const std::string& uav_name, const std::string& command,
        ...
        StreamMode getStreamMode() const { return stream_mode_; }
        ...
        NetworkStats getNetworkStats() { return network_stats_; }
        ...
        Permission getUserPermissions() const { return user_permissions_; }
        ...
        DataFormat getDataFormat() const { return data_format_; }
...
// platform-specific APIs like /proc/stat on Linux or GetSystemTimes on Windows
    ...
    // Streaming & Buffering
    bool TelemetryClientAdvanced::setStreamMode(StreamMode mode) { return pAdvancedImpl->setStreamMode(mode); }

    StreamMode TelemetryClientAdvanced::getStreamMode() const { return pAdvancedImpl->getStreamMode(); }
    ...
    bool TelemetryClientAdvanced::enableAutoFailover(bool enable) { return pAdvancedImpl->enableAutoFailover(enable); }

    NetworkStats TelemetryClientAdvanced::getNetworkStats() { return pAdvancedImpl->getNetworkStats(); }
    ...
    // Security & Authentication
    bool TelemetryClientAdvanced::authenticate(const AuthConfig& config) { return pAdvancedImpl->authenticate(config); }
    ...
    Permission TelemetryClientAdvanced::getUserPermissions() const { return pAdvancedImpl->getUserPermissions(); }

    // Configuration & Profiles
    bool TelemetryClientAdvanced::setOperationMode(OperationMode mode) { return pAdvancedImpl->setOperationMode(mode); }

    OperationMode TelemetryClientAdvanced::getOperationMode() const { return pAdvancedImpl->getOperationMode(); }
    ...
    ConfigurationProfile TelemetryClientAdvanced::getCurrentProfile() { return pAdvancedImpl->getCurrentProfile(); }

    // Data Format & Protocol Settings
    bool TelemetryClientAdvanced::setDataFormat(DataFormat format) { return pAdvancedImpl->setDataFormat(format); }

    DataFormat TelemetryClientAdvanced::getDataFormat() const { return pAdvancedImpl->getDataFormat(); }
    ...
    // Component Access
    std::weak_ptr<DataAnalyzer> TelemetryClientAdvanced::getDataAnalyzer() { return pAdvancedImpl->getDataAnalyzer(); }

    std::weak_ptr<FleetManager> TelemetryClientAdvanced::getFleetManager() { return pAdvancedImpl->getFleetManager(); }

    std::weak_ptr<DataBuffer> TelemetryClientAdvanced::getDataBuffer() { return pAdvancedImpl->getDataBuffer(); }

    std::weak_ptr<MockUAV> TelemetryClientAdvanced::getMockUAV() { return pAdvancedImpl->getMockUAV(); }
